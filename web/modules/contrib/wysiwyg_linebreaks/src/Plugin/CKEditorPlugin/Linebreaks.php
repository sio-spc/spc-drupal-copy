...
class Linebreaks extends PluginBase implements CKEditorPluginInterface, CKEditorPluginContextualInterface, CKEditorPluginConfigurableInterface {
  ...
  public function getConfig(Editor $editor) {
    return array(
      'linebreaks_method' => isset($editor->settings['plugins']['linebreaks']) ? $editor->settings['plugins']['linebreaks']['method'] : 'force',
    );
  }
  ...
  public function settingsForm(array $form, FormStateInterface $form_state, Editor $editor) {
    $form['method'] = array(
      ...
      '#default_value' => isset($editor->settings['plugins']['linebreaks']) ? $editor->settings['plugins']['linebreaks']['method'] : 'force',
      '#options' => array(
